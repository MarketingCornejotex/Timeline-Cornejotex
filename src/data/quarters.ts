  ...
  Q2: {
    ...
    months: [
      ...
      },
      {
        ...
        licenses: [
          { name: 'Casper',     type: 'ann', segs: [A,N,H,M], licensor: 'Universal' },
          { name: 'Pusheen',    type: 'ann', segs: [A,N,H,M], licensor: 'Pusheen' },
      ...
      },
      {
        ...
        licenses: [
          { name: 'E.T.',                    type: 'ann', segs: [A,N,H,M], licensor: 'Universal' },
          { name: 'Fast & Furious',          type: 'ann', segs: [A,H,M],   licensor: 'Universal' },
          { name: 'Jaws',                    type: 'ann', segs: [A,H,M],   licensor: 'Universal' },
          { name: 'Jurassic World',          type: 'ann', segs: [A,N,H,M], licensor: 'Universal' },
          { name: 'Jurassic Park',           type: 'ann', segs: [A,N,H,M], licensor: 'Universal' },
